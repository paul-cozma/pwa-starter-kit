webpackJsonp([2],Array(71).concat([
/* 71 */
...
var _mediaQuery = __webpack_require__(67);
...
var MainAutor = function (_connect) {
    _inherits(MainAutor, _connect);

    function MainAutor() {
        _classCallCheck(this, MainAutor);

        return _possibleConstructorReturn(this, (MainAutor.__proto__ || Object.getPrototypeOf(MainAutor)).apply(this, arguments));
    }

    _createClass(MainAutor, [{
        key: 'ready',
        value: function ready() {
            _get(MainAutor.prototype.__proto__ || Object.getPrototypeOf(MainAutor.prototype), 'ready', this).call(this);
        }
    }, {
        key: '_stateChanged',
        ...
        key: '_idChanged',
        value: function _idChanged(name) {
            var _this2 = this;

            this.set('posts', []);
            this.set('pageNumber', 1);
            (0, _axios2.default)(_config.config.url + '/users/?_embed&slug=' + name).then(function (data) {
                console.log(data);
                _this2.data = data.data[0];
                (0, _metadata.updateMetadata)({

                    title: _this2.data.name + ' | Soulmatters.ro',
                    description: 'Fii și tu autor pe soulmatters.ro',
                    url: document.location.href,
                    image: '/content' + _this2.data.avatar_urls[96]
                });
                console.log(_this2.data);
                _this2.getPosts(data.data[0].id, _this2.pageNumber);
            });
        }
    }, {
        key: 'getPosts',
        value: function getPosts(id, page) {
            var _this3 = this;

            (0, _axios2.default)(_config.config.url + '/posts/?_embed&author=' + id + '&page=' + page).then(function (data) {
                _this3.set('totalPosts', data.headers['x-wp-total']);

                if (data.code === 'rest_post_invalid_page_number') {
                    _this3.removeEventListener('template-loaded');
                } else {
                    _this3.set('posts', _this3.posts.concat(data.data));
                }
            });
        }
    }, {
        ...
        value: function observe(e) {
            ...
            var myImgs = this.shadowRoot.querySelector('post-card');
            var config = {
                root: document.body,
                rootMargin: '0px',
            ...
            var observer = new IntersectionObserver(function (entries) {
                entries.forEach(function (entry) {
                    console.log(_this4.pageNumber, _typeof(_this4.pageNumber));
                    if (entry.intersectionRatio > 0) {
                        _this4.pageNumber += 1;
                        _this4.getPosts(_this4.data.id, _this4.pageNumber);
        ...
        value: function ready() {
            ...
            _get(MainAutor.prototype.__proto__ || Object.getPrototypeOf(MainAutor.prototype), 'ready', this).call(this);
            this.addEventListener('template-loaded', function (e) {
    ...
    return MainAutor;
}((0, _connectMixin.connect)(_store.store)(_polymer.PolymerElement));
...
;(function (global, factory) {
    ( false ? 'undefined' : _typeof(exports)) === 'object' && typeof module !== 'undefined' && "function" === 'function' ? factory(__webpack_require__(148)) :  true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(148)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
...
var template = (0, _htmlTag.html)(_templateObject);
...
exports.unsafeHTML = undefined;

var _parts = __webpack_require__(19);

var _litHtml = __webpack_require__(18);
 ...
 * vulnerabilities.
 */
var unsafeHTML = exports.unsafeHTML = (0, _litHtml.directive)(function (value) {
    return function (part) {
        ...
        previousValues.set(part, { value: value, fragment: fragment });
    };
});
...
var _templateObject = _taggedTemplateLiteral(["\n    \n    <div class=\"wrapper\" id=\"wrapper\">\n      ", "\n</div>\n<style>\n  .item {\n    transition: all 0.3s ease-in-out;\n  }\n\n  .wrapper {\n  max-width: 1200px;\n  width: 100%;\n  margin: 20px auto;\n  display: flex;\n  justify-content: center;\n  grid-gap: 30px;\n  max-width: 1200px;\n  flex-flow: wrap row;\n}\nimg {\n  width: 100%;\n  height: 250px;\n  object-fit: cover;\n}\n.item {\n  max-width: 100%;\n  box-sizing: border-box;\n  background: #fff;\n  border-radius: 8px;\n  border-bottom: solid 2px #639;\n  opacity: 0;\n  display: flex;\n  flex-flow: wrap column;\n}\n.item .img {\n  overflow: hidden;\n}\n.item img {\n  border-radius: 8px 8px 0 0;\n  transition: all 0.3s ease-in-out;\n}\n.item img:hover {\n  transform: scale(1.1);\n}\n.item:not(first-child) {\n  margin: 20px;\n  flex: 1 1 300px;\n}\n.item:nth-child(6n+1) {\n  width: 100%;\n  flex: 1 1 100%;\n  flex-flow: wrap row;\n}\n.item:nth-child(6n+1) .img {\n  flex: 1;\n  height: 330px;\n}\n.item:nth-child(6n+1) .meta {\n  flex: 1;\n}\n.item:nth-child(6n+1) img {\n  border-radius: 8px 0px 0px 8px;\n  height: 100%;\n}\n@media screen and (max-width: 722px) {\n  .item:nth-child(6n+1) {\n    max-width: 100%;\n    box-sizing: border-box;\n    background: #fff;\n    border-radius: 8px;\n    border-bottom: solid 2px #639;\n    opacity: 0;\n    display: flex;\n    flex-flow: wrap column;\n  }\n  .item:nth-child(6n+1) img {\n    height: 250px;\n    border-radius: 8px 8px 0 0;\n  }\n}\nh3{\n  font-size: 19px;\n  font-weight: 400;\n  color: #212121;\n}\nmarked-element {\n  flex: 1;\n}\na {\n  text-decoration: none;\n}\np {\n  font-size: 16px;\n  font-weight: 300;\n}\n.meta {\n  padding: 20px;\n}\n.header {\n  background: url(\"/assets/large/images/meteorit.jpg\") center center no-repeat;\n  height: 550px;\n  width: 100%;\n  margin-top: -60px;\n  display: flex;\n  flex-flow: wrap column;\n  justify-content: center;\n  align-items: center;\n}\nh1 {\n  font-family: \"Segoe UI\", Roboto, Oxygen, Ubuntu, Cantarell, \"Open Sans\", \"Helvetica Neue\", sans-serif;\n  font-size: 42px;\n  font-weight: 300;\n  color: #fff;\n  text-shadow: 0 2px 4px #212112;\n}\n.container {\n  width: 100vw;\n}\n.logo img {\n  width: 120px;\n}\n.tag {\n  font-size: 13px;\n  color: #26a8ed;\n  font-weight: bold;\n}\n\n</style>\n\n    "], ["\n    \n    <div class=\"wrapper\" id=\"wrapper\">\n      ", "\n</div>\n<style>\n  .item {\n    transition: all 0.3s ease-in-out;\n  }\n\n  .wrapper {\n  max-width: 1200px;\n  width: 100%;\n  margin: 20px auto;\n  display: flex;\n  justify-content: center;\n  grid-gap: 30px;\n  max-width: 1200px;\n  flex-flow: wrap row;\n}\nimg {\n  width: 100%;\n  height: 250px;\n  object-fit: cover;\n}\n.item {\n  max-width: 100%;\n  box-sizing: border-box;\n  background: #fff;\n  border-radius: 8px;\n  border-bottom: solid 2px #639;\n  opacity: 0;\n  display: flex;\n  flex-flow: wrap column;\n}\n.item .img {\n  overflow: hidden;\n}\n.item img {\n  border-radius: 8px 8px 0 0;\n  transition: all 0.3s ease-in-out;\n}\n.item img:hover {\n  transform: scale(1.1);\n}\n.item:not(first-child) {\n  margin: 20px;\n  flex: 1 1 300px;\n}\n.item:nth-child(6n+1) {\n  width: 100%;\n  flex: 1 1 100%;\n  flex-flow: wrap row;\n}\n.item:nth-child(6n+1) .img {\n  flex: 1;\n  height: 330px;\n}\n.item:nth-child(6n+1) .meta {\n  flex: 1;\n}\n.item:nth-child(6n+1) img {\n  border-radius: 8px 0px 0px 8px;\n  height: 100%;\n}\n@media screen and (max-width: 722px) {\n  .item:nth-child(6n+1) {\n    max-width: 100%;\n    box-sizing: border-box;\n    background: #fff;\n    border-radius: 8px;\n    border-bottom: solid 2px #639;\n    opacity: 0;\n    display: flex;\n    flex-flow: wrap column;\n  }\n  .item:nth-child(6n+1) img {\n    height: 250px;\n    border-radius: 8px 8px 0 0;\n  }\n}\nh3{\n  font-size: 19px;\n  font-weight: 400;\n  color: #212121;\n}\nmarked-element {\n  flex: 1;\n}\na {\n  text-decoration: none;\n}\np {\n  font-size: 16px;\n  font-weight: 300;\n}\n.meta {\n  padding: 20px;\n}\n.header {\n  background: url(\"/assets/large/images/meteorit.jpg\") center center no-repeat;\n  height: 550px;\n  width: 100%;\n  margin-top: -60px;\n  display: flex;\n  flex-flow: wrap column;\n  justify-content: center;\n  align-items: center;\n}\nh1 {\n  font-family: \"Segoe UI\", Roboto, Oxygen, Ubuntu, Cantarell, \"Open Sans\", \"Helvetica Neue\", sans-serif;\n  font-size: 42px;\n  font-weight: 300;\n  color: #fff;\n  text-shadow: 0 2px 4px #212112;\n}\n.container {\n  width: 100vw;\n}\n.logo img {\n  width: 120px;\n}\n.tag {\n  font-size: 13px;\n  color: #26a8ed;\n  font-weight: bold;\n}\n\n</style>\n\n    "]),
    _templateObject2 = _taggedTemplateLiteral(["      \n    <div class=\"item\">\n      <a class=\"img\" href=\"/blog/", "/", "/", "/", "\">\n        <img loading=\"lazy\" src=\"", "\" sizing=\"cover\" alt=\"", "\" />\n      </a>\n      <div class=\"meta\">\n        <a href=\"/blog/", "/", "/", "/", "\">\n            <h3 slot=\"markdown-html\">", "</h3> \n        </a>\n\n        <div>\n        ", "\n        </div>\n        <autor-card .uid=\"", "\"></autor-card>\n      </div>\n    </div>\n  "], ["      \n    <div class=\"item\">\n      <a class=\"img\" href=\"/blog/", "/", "/", "/", "\">\n        <img loading=\"lazy\" src=\"", "\" sizing=\"cover\" alt=\"", "\" />\n      </a>\n      <div class=\"meta\">\n        <a href=\"/blog/", "/", "/", "/", "\">\n            <h3 slot=\"markdown-html\">", "</h3> \n        </a>\n\n        <div>\n        ", "\n        </div>\n        <autor-card .uid=\"", "\"></autor-card>\n      </div>\n    </div>\n  "]);

var _litElement = __webpack_require__(33);

var _animejs = __webpack_require__(312);
...
var _unsafeHtml = __webpack_require__(310);
...
var PostCard = function (_LitElement) {
  _inherits(PostCard, _LitElement);
  ...
  _createClass(PostCard, [{
    ...
    value: function render() {
      ...
      return (0, _litElement.html)(_templateObject, this.post.map(function (item, index) {
        return (0, _litElement.html)(_templateObject2, _this2.year(item.date), _this2.month(item.date), _this2.day(item.date), item.permalink, _this2.removeHttp(item.imagine, item.image), item.Title, _this2.year(item.date), _this2.month(item.date), _this2.day(item.date), item.permalink, (0, _unsafeHtml.unsafeHTML)(item.Title), (0, _unsafeHtml.unsafeHTML)(_this2.substr(item.body, index)), item.user);
      }));
    }
  }, {
    key: "updated",
    ...
    value: function observe() {
      ...
      var myImgs = this.shadowRoot.querySelectorAll(".item");
      ...
      var observer = new IntersectionObserver(function (entries) {
        entries.forEach(function (entry) {
          if (entry.intersectionRatio > 0) {
            console.log(_this3.shadowRoot.getElementById('wrapper').lastElementChild.previousElementSibling === entry.target);
            if (_this3.shadowRoot.getElementById('wrapper').lastElementChild.previousElementSibling === entry.target) {
              _this3.dispatchEvent(new CustomEvent("template-loaded", {
                bubbles: true,
                composed: true
              }));
            }
            entry.target.style.display = "flex";
            var image = entry.target.querySelector("a").querySelector("img");
    ...
    key: "removeHttp",
    value: function removeHttp(source, image) {
      if (image !== null) {
        return "https://api.soulmatters.ro" + image.url;
      } else {
        var _image = "https://api.soulmatters.ro" + source;
        return _image;
      }
    }
  }, {
    key: "substr",
    value: function substr(body, index) {
      var length = index === 0 ? 340 : 240;
...
var AutorCard = function (_PolymerElement) {
    _inherits(AutorCard, _PolymerElement);

    function AutorCard() {
        _classCallCheck(this, AutorCard);

        return _possibleConstructorReturn(this, (AutorCard.__proto__ || Object.getPrototypeOf(AutorCard)).apply(this, arguments));
    }

    _createClass(AutorCard, [{
        key: 'ready',
        value: function ready() {
            _get(AutorCard.prototype.__proto__ || Object.getPrototypeOf(AutorCard.prototype), 'ready', this).call(this);
        }
    }, {
        key: 'addURL',
        value: function addURL(img) {
...
module.exports = "<div class=\"autor-wrapper\">\n    <img src=\"[[addURL(uid.image.url)]]\" alt=\"[[uid.name]]\">\n    <h4>[[uid.Name]]</h4>\n</div>"
...
// module
exports.push([module.i, ".autor-wrapper {\n  display: flex;\n  flex-flow: wrap row;\n  align-items: center;\n}\n.autor-wrapper img {\n  width: 25px;\n  border-radius: 50%;\n  margin-right: 10px;\n}\n.autor-wrapper a {\n  color: #26a8ed;\n  text-decoration: none;\n  text-transform: uppercase;\n  font-family: \"Segoe UI\", Roboto, Oxygen, Ubuntu, Cantarell, \"Open Sans\", \"Helvetica Neue\", sans-serif;\n}\n.autor-wrapper a h4 {\n  font-size: 13px;\n}\n", ""]);
...
module.exports = "<style include=\"paper-styles\">\n    .wrapper{\n        max-width: 1200px;\n        width: 100%;\n        margin: 20px auto;\n        display: grid;\n        grid-template-columns: repeat(auto-fit, 300px);\n        justify-content: center;\n        grid-gap: 30px;\n    }\n    \n   iron-image{\n       width:100%;\n       height: 250px;\n   }\n    .item{\n        max-width: 100%;\n        @apply --shadow-elevation-2dp;\n        box-sizing: border-box;\n        background: #fff;\n        border-radius: 8px;\n        \n    }\n    \n    .item:nth-child(4n+1){\n        grid-column: span 2\n    }\n    .item:nth-child(6n+1){\n        grid-column: span 3\n    }\n    \n    .item:first-child{\n        grid-column: span 3\n    }\n    h3{\n        font-size: 19px;\n        font-weight: 400;\n        color:#212121;\n    }\n    a{\n        text-decoration: none;\n        \n    }\n    p{\n        font-size: 16px;\n        font-weight: 300;\n    }\n    .meta{\n        padding: 20px;\n    }\n    .header{\n        background: url(/assets/large/images/meteorit.jpg) center center no-repeat;\n        height: 550px;\n        width:100%;\n        margin-top: -60px;\n        display: flex;\n        flex-flow: wrap column;\n        justify-content: center;\n        align-items: center;\n\n    }\n    h1{\n        font-family:  \"Segoe UI\", Roboto, Oxygen, Ubuntu, Cantarell, \"Open Sans\", \"Helvetica Neue\", sans-serif;\n        font-size: 42px;\n        font-weight: 300;\n        color:#fff;\n        text-shadow: 0 2px 4px #212112\n    }\n    .container{\n        width:100vw;\n    }\n    .logo img{\n        width: 120px;\n    }\n</style>\n<div class=\"container\">\n    <div class=\"autor-wrapper\">\n        <img src=\"[[data.avatar_urls.96]]\" alt=\"[[data.name]]\">\n<h4>[[data.name]]</h4>\n<h5>Număr total de articole: [[totalPosts]]</h5>\n</div>\n\n<post-card post=\"{{posts}}\"></post-card>\n\n</div>"
