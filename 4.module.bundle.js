webpackJsonp([4],Array(143).concat([
/* 143 */
...
class MainTag extends (0, _connectMixin.connect)(_store.store)(_polymer.PolymerElement) {
    static get template() {
    ...
    _tagChanged(name) {
        ...
        (0, _axios2.default)(`http://127.0.0.1/wp-json/wp/v2/tags/?_embed&slug=${name}`).then(data => {
            console.log(data);
    ...
    getPosts(id, page) {
        (0, _axios2.default)(`http://127.0.0.1/wp-json/wp/v2/posts/?_embed&tags=${id}&page=${page}`).then(data => {
            console.log(data);
