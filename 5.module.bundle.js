...
class MainLogin extends _polymer.PolymerElement {
    static get template() {
...
module.exports = "<auth-box></auth-box>"
...
class AuthBox extends _polymer.PolymerElement {
    static get template() {
        return (0, _polymer.html)([`${_template2.default} <style>${_style2.default} </style>`]);
    }
    ready() {
...
module.exports = "<div class=\"container\">\n    <div class=\"login\" >\n        <input type=\"text\" name=\"username\" placeholder=\"Nume utilizator\" id=\"username\">\n        <input type=\"password\" id=\"password\">        \n        <paper-button raised on-tap=\"login\">Logare</paper-button>        \n    </div>\n</div>"
