webpackJsonp([4],Array(146).concat([
/* 146 */
...
var MainTag = function (_connect) {
    _inherits(MainTag, _connect);

    function MainTag() {
        _classCallCheck(this, MainTag);

        return _possibleConstructorReturn(this, (MainTag.__proto__ || Object.getPrototypeOf(MainTag)).apply(this, arguments));
    }

    _createClass(MainTag, [{
        key: 'ready',
        value: function ready() {
            _get(MainTag.prototype.__proto__ || Object.getPrototypeOf(MainTag.prototype), 'ready', this).call(this);
        }
    }, {
        key: '_stateChanged',
        ...
        key: '_tagChanged',
        value: function _tagChanged(name) {
            var _this2 = this;

            this.set('posts', []);
            this.set('pageNumber', 1);
            (0, _axios2.default)('http://127.0.0.1/wp-json/wp/v2/tags/?_embed&slug=' + name).then(function (data) {
                console.log(data);
        ...
        value: function getPosts(id, page) {
            ...
            (0, _axios2.default)('http://127.0.0.1/wp-json/wp/v2/posts/?_embed&tags=' + id + '&page=' + page).then(function (data) {
                console.log(data);
