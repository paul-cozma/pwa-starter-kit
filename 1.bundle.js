...
var _sharedStyle = __webpack_require__(336);

var _sharedStyle2 = _interopRequireDefault(_sharedStyle);
...
var MyHome = function (_connect) {
  _inherits(MyHome, _connect);

  function MyHome() {
    _classCallCheck(this, MyHome);

    return _possibleConstructorReturn(this, (MyHome.__proto__ || Object.getPrototypeOf(MyHome)).apply(this, arguments));
  }
  ...
  _createClass(MyHome, [{
    ...
    value: function ready() {
      ...
      _get(MyHome.prototype.__proto__ || Object.getPrototypeOf(MyHome.prototype), 'ready', this).call(this);
        ...
        return _regenerator2.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                this.loading = true;
                fetch(_config.config.url + '/posts?_start=' + page + '&_limit=6&_sort=createdAt:desc&published=true').then(function (data) {
                  return data.json();
                }).then(function (res) {
                  if (page === 1) {
                    _this3.data = res;
                    ...
                    _this3.removeEventListener('template-loaded', null);
                    _this3.loading = false;
                  } else {

                    _this3.set('data', _this3.data.concat(res));
                    _this3.loading = false;
                    _this3.pageNumber = _this3.pageNumber + 10;
                  }
                }).catch(function (err) {
                  console.log(err);
                });
      ...
      var observer = new IntersectionObserver(function (entries) {
        entries.forEach(function (entry) {
          ...
          if (entry.intersectionRatio > 0) {
            _this4.pageNumber += 1;
            _this4.getPosts(_this4.pageNumber);
...
module.exports = {"attributes":{"title":"Acasa","date":"2018-06-01 12:00am","image":"/images/bufscalat.jpg","description":"Soulmatters - Pentru noi!\n"},"body":"\ntest\n","frontmatter":"title: Acasa\ndate: '2018-06-01 12:00am'\nimage: /images/bufscalat.jpg\ndescription: |\n  Soulmatters - Pentru noi!"}
