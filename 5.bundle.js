...
var _template = __webpack_require__(365);
...
var MainLogin = function (_PolymerElement) {
    _inherits(MainLogin, _PolymerElement);

    function MainLogin() {
        _classCallCheck(this, MainLogin);

        return _possibleConstructorReturn(this, (MainLogin.__proto__ || Object.getPrototypeOf(MainLogin)).apply(this, arguments));
    }

    _createClass(MainLogin, [{
        key: 'ready',
        value: function ready() {
            _get(MainLogin.prototype.__proto__ || Object.getPrototypeOf(MainLogin.prototype), 'ready', this).call(this);
        }
    }], [{
        key: 'template',
        get: function get() {
...
var AuthBox = function (_PolymerElement) {
    _inherits(AuthBox, _PolymerElement);

    function AuthBox() {
        _classCallCheck(this, AuthBox);

        return _possibleConstructorReturn(this, (AuthBox.__proto__ || Object.getPrototypeOf(AuthBox)).apply(this, arguments));
    }

    _createClass(AuthBox, [{
        key: 'ready',
        value: function ready() {
            _get(AuthBox.prototype.__proto__ || Object.getPrototypeOf(AuthBox.prototype), 'ready', this).call(this);
        ...
        value: function login() {
            ...
            var url = "http://127.0.0.1/wp-json/jwt-auth/v1/token";
            var options = {
