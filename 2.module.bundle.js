...
var _mediaQuery = __webpack_require__(66);
...
class MainAutor extends (0, _connectMixin.connect)(_store.store)(_polymer.PolymerElement) {
    static get template() {
    ...
    _idChanged(name) {
        ...
        (0, _axios2.default)(`${_config.config.url}/users/?_embed&slug=${name}`).then(data => {
            console.log(data);
    ...
    getPosts(id, page) {
        (0, _axios2.default)(`${_config.config.url}/posts/?_embed&author=${id}&page=${page}`).then(data => {
