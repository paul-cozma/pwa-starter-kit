...
var _templateObject = _taggedTemplateLiteral(["\n    <div class=\"container\">\n        ", "\n</div>\n<style>\niron-image {\n  width: 100%;\n  max-width: 1500px;\n  height: 600px;\n  margin: 0 auto;\n  display: block;\n}\n.wrapper {\n  width: 100%;\n  max-width: 800px;\n  margin: 0 auto;\n  margin-top: -150px;\n  background: #fff;\n  padding: 30px 70px;\n  z-index: 99;\n  position: relative;\n  box-sizing: border-box;\n}\n@media screen and (max-width: 620px) {\n  .wrapper {\n    padding: 40px 30px;\n  }\n}\n .body{\n  font-size: 22px;\n  font-weight: 300;\n  line-height: 1.5em;\n-webkit-user-modify:read-write-plaintext-only;\n}\n\nh1 {\n  text-align: center;\n}\nh1 {\n  font-size: 50px !important;\n  font-weight: 400;\n  color: primary-color;\n  margin-top: 0;\n}\n:host {\n  display: block;\n}\n.container {\n  background: #fff;\n  width: 100%;\n  margin: 0 auto;\n}\nh3 {\n  text-transform: capitalize;\n  text-align: center;\n}\n\n</style>\n    "], ["\n    <div class=\"container\">\n        ", "\n</div>\n<style>\niron-image {\n  width: 100%;\n  max-width: 1500px;\n  height: 600px;\n  margin: 0 auto;\n  display: block;\n}\n.wrapper {\n  width: 100%;\n  max-width: 800px;\n  margin: 0 auto;\n  margin-top: -150px;\n  background: #fff;\n  padding: 30px 70px;\n  z-index: 99;\n  position: relative;\n  box-sizing: border-box;\n}\n@media screen and (max-width: 620px) {\n  .wrapper {\n    padding: 40px 30px;\n  }\n}\n .body{\n  font-size: 22px;\n  font-weight: 300;\n  line-height: 1.5em;\n-webkit-user-modify:read-write-plaintext-only;\n}\n\nh1 {\n  text-align: center;\n}\nh1 {\n  font-size: 50px !important;\n  font-weight: 400;\n  color: primary-color;\n  margin-top: 0;\n}\n:host {\n  display: block;\n}\n.container {\n  background: #fff;\n  width: 100%;\n  margin: 0 auto;\n}\nh3 {\n  text-transform: capitalize;\n  text-align: center;\n}\n\n</style>\n    "]),
    _templateObject2 = _taggedTemplateLiteral(["\n          <h1>", "</h1>\n        <h3>", "</h3>\n        <iron-image src=\"", "\"\n          placeholder=\"", "\" sizing=\"cover\" fade preload alt=\"\"></iron-image>\n        <div class=\"wrapper\">\n          <image-loader></image-loader>\n          <div class=\"body\">\n              ", "\n            </div>\n\n          <user-box .uid=\"", "\"></user-box>\n        </div>\n        "], ["\n          <h1>", "</h1>\n        <h3>", "</h3>\n        <iron-image src=\"", "\"\n          placeholder=\"", "\" sizing=\"cover\" fade preload alt=\"\"></iron-image>\n        <div class=\"wrapper\">\n          <image-loader></image-loader>\n          <div class=\"body\">\n              ", "\n            </div>\n\n          <user-box .uid=\"", "\"></user-box>\n        </div>\n        "]);
...
var MainBlog = function (_LitElement) {
  _inherits(MainBlog, _LitElement);

  _createClass(MainBlog, [{
    key: "render",
    value: function render() {
      return (0, _litElement.html)(_templateObject, this.loading ? '' : (0, _litElement.html)(_templateObject2, (0, _unsafeHtml.unsafeHTML)(this.article.Title), this.date(this.article.date), this.removeHttp(this.article.imagine, this.article.image), this.removeHttp(this.article.imagine, this.article.image), (0, _unsafeHtml.unsafeHTML)(this.article.body), this.article.user));
    }
  }, {
    key: "_getArticle",
    value: function () {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                post = this.slug;
                _context.next = 3;
                return fetch(_config.config.url + "/posts/?permalink_eq=" + post).then(function (data) {
                  return data.json();
                });
  ...
  _createClass(MainBlog, [{
    ...
    value: function date(_date) {
      _moment2.default.locale("ro");

      return (0, _moment2.default)(_date).format("Do MMMM, YYYY");
    }
  }, {
    key: "removeHttp",
...
var _ironA11yKeysBehavior = __webpack_require__(63);
...
var _paperButtonBehavior = __webpack_require__(331);

var _polymerFn = __webpack_require__(3);

var _polymerLegacy = __webpack_require__(0);
...
var template = (0, _polymerLegacy.html)(_templateObject);
...
var _ironButtonState = __webpack_require__(325);

var _ironControlState = __webpack_require__(326);

var _paperRippleBehavior = __webpack_require__(332);
...
var UserBox = function (_PolymerElement) {
    _inherits(UserBox, _PolymerElement);
    ...
    _createClass(UserBox, [{
        key: 'ready',
        value: function ready() {
            _get(UserBox.prototype.__proto__ || Object.getPrototypeOf(UserBox.prototype), 'ready', this).call(this);
        }
    }, {
        key: 'addURL',
...
var CommentBox = function (_PolymerElement) {
    _inherits(CommentBox, _PolymerElement);
    ...
    _createClass(CommentBox, [{
        key: 'ready',
        value: function ready() {
            _get(CommentBox.prototype.__proto__ || Object.getPrototypeOf(CommentBox.prototype), 'ready', this).call(this);
        }
    }, {
        key: 'date',
        value: function date(_date) {
            return (0, _moment2.default)(_date).startOf('minute').fromNow();
        }
    }, {
        key: 'changed',
        value: function changed(data) {
            console.log(data);
        }
    }, {
        key: 'getComments',
                ...
                return _regenerator2.default.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                _context.next = 2;
                                return fetch('http://127.0.0.1/wp-json/wp/v2/comments/' + post).then(function (data) {
                                    return data.json();
                                });
        ...
        value: function sendComment() {
            ...
            var url = 'http://127.0.0.1/wp-json/wp/v2/comments';
            ...
            var snack = this.shadowRoot.querySelector('paper-toast');
            fetch(url, {
                method: 'POST',
                headers: {
                ...
                if (data.code === 'rest_comment_content_invalid') {
                    ...
                    website.value = '';
                    mesaj.value = '';
                    _this2.dispatchEvent(new CustomEvent('comment-approved', { bubbles: true, composed: true }));
                }
            }).catch(function (err) {
                console.log(err);
...
module.exports = "<div class=\"container\">\n<h3>Comentarii ([[count(comments)]])</h3>\n    <template is=\"dom-repeat\" items=\"{{comments}}\">\n        <div class=\"comment_wrapper\">\n            <a href=\"[[item.author_url]]\" class=\"author_wrapper\">\n                <img src=\"[[item.author_avatar_urls.48]]\" alt=\"\"> \n            </a>\n           \n            <div class=\"comment\">\n                <div class=\"author\">\n                <a href=\"[[item.author_url]]\">\n                    <h4>[[item.author_name]]</h4>\n                    \n                </a>\n                <span>&nbsp;&#9679;&nbsp;</span>\n                    <h4>[[date(item.date)]]</h4>\n            </div>\n                <marked-element markdown=\"[[item.content.rendered]]\">\n                    <div slot=\"markdown-html\"></div>\n                </marked-element>\n            </div>\n        </div>\n    </template>\n    <div class=\"comment\">\n        <h3>Lasă comentariul tău aici</h3>\n        <input type=\"text\" placeholder=\"Nume\" id=\"name\">\n        <input type=\"text\" placeholder=\"Website\" id=\"website\">\n        <input type=\"text\" placeholder=\"email\" pattern=\"[a-z0-9._%+-]+@[a-z0-9.-]+\\.[a-z]{2,4}$\" id=\"email\">\n        <textarea name=\"message\" id=\"mesaj\" cols=\"30\" rows=\"10\" placeholder=\"Mesaj\"></textarea>\n        <paper-button on-tap=\"sendComment\">Trimite</paper-button>\n    </div>\n    <paper-toast></paper-toast>\n</div>"
